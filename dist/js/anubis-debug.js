(()=>{(function(){if(typeof window>"u"||typeof document>"u"||window.AnubisDebugPanel)return;function E(a){try{return JSON.stringify(a,null,2)}catch{return String(a)}}let C=`
    ...
    `;function _(){return new Date().toLocaleTimeString()}function T(){let a=document.createElement("div");a.className="debug-host";let s=a.attachShadow({mode:"open"}),r=document.createElement("style");r.textContent=C,s.appendChild(r);let i=document.createElement("aside");return i.className="debug",i.setAttribute("aria-live","polite"),i.innerHTML=`
